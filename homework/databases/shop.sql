...
CREATE TABLE `products` (
  ...
  CONSTRAINT `product_user_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `products` VALUES (1,'Rolex','Rolex | Watch | Shop','bla bla bla bla bla bla bla bla bla bla bla bla',14000.25,NULL,1,0);
...
-- Dump completed on 2021-10-17 23:06:03
